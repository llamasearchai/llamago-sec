# Contributing to LlamaGo Sec

Thank you for your interest in contributing to LlamaGo Sec! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaGo Sec:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamago-sec.git
   cd llamago-sec
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamago-sec.git
   ```
...
By contributing to LlamaGo Sec, you agree that your contributions will be licensed under the project's MIT License.
